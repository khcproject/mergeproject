...
<body>
<c:if test="${sessionScope.userchk=='S'}">
<script>
 alert('구매자가 아닙니다.');
	...
	<div class="full_sub">
		...
		<div class="mainmenu">
			...
			<form class="form-horizontal" id="nsfrm" method="POST">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="nsSaupja_num">사업자 번호</label>
					<div class="col-sm-6">
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.
			...
			<div id="div2">
                    <input type="radio" id="rb1" name="gg" /><label for="rb1">약관에 동의합니다.</label>
                    <input type="radio" id="rb2" name="gg" checked="checked" />
                    <label for="rb2">약관에 동의 하지 않습니다.</label>
             </div>
				<input type="hidden" name="allow_chk" value="R" />
